...
export const content: ContentConfig = {
  ...
  colors: {
    primary: '#EFEB1A',      // Cor principal (Botões, destaques, ícones)
    primaryDark: '#ffffffff',  // Cor principal escura (Hover)
    primaryHighlight: '#EFEB1A', // Cor para textos destacados e ícones soltos (Pode ser igual a primary ou ajustada)
  ...
  // ==================================================================================
  seo: {
    title: "Mutante Gym - Começe 2026 Em Forma: Garanta Sua Matrícula Com Desconto",
    description: "Treinos inovadores, profissionais qualificados e um ambiente acolhedor",
    domain: "https://mutantegym.netlify.app", // URL do site (sem barra no final)
    path: "/",
    themeColor: "#EFEB1A", // Cor do tema (barra de endereço mobile)
    keywords: "academia, musculação, fitness, saúde, treino, jiu jitsu, muay thai, fit dance, lutas, funcional, londrina",
    og: {
      title: "Mutante Gym - Começe 2026 Em Forma: Garanta Sua Matrícula Com Desconto",
      description: "Treinos inovadores, profissionais qualificados e um ambiente acolhedor",
      type: "website",
      siteName: "Mutante Gym",
  ...
  infos: {
    ...
    phone: "(19) 99558-4623",
    whatsapp: "5519995584623", // Apenas números, com código do país (55) e DDD
    email: "contato@mutantegym.com.br",
    address: "R. Bárbara Heliodora, 555 - Dic IV (Conjunto Hab. Lech Walesa), Campinas - SP",
    mapsLink: "https://maps.app.goo.gl/2J55bqEwEp68z4UZA", // Link para abrir no Google Maps
    // Iframe do Google Maps (Copiar do Google Maps -> Compartilhar -> Incorporar um mapa)
    mapsEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58768.73003506169!2d-47.17391581812785!3d-22.98534959999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c8c9f54373efc7%3A0x98ae3340137906d7!2sACADEMIA%20MUTANTE%20GYM!5e0!3m2!1spt-BR!2sbr!4v1764622450597!5m2!1spt-BR!2sbr",
  },
  ...
  hero: {
    enabled: true,
    badge: "DIC IV, Campinas/SP", //Nova unidade aberta"
    headline: {
  ...
  stats: {
    ...
    items: [
      {
        value: "4.9/5.0",
        label: "+130 Avaliações no Google",
  ...
  team: {
    ...
    members: [
      ...
      {
        name: "Júlia Lima",
        role: "Professora de Fit Dance e Ritmos Fitness",
        image: images.team4,
        instagram: "#"
      }
    ]
  ...
  location: {
    ...
    hours: [
      { label: "Seg - Sex", time: "05:00 - 00:00" },
    ...
    plans: [
      {
        ...
        price: '89,99',
        period: '/mês',
        features: ['Musculação + Aulas (Ritmos, Capoeira Kids, Jump 360, FitDance, Muay Thai)', 'Menor preço garantido', '12x no cartão', 'Fidelidade 12 meses'],
        highlighted: true,
        badgeText: "MAIS ESCOLHIDO",
        discountText: "40% de desconto",
        buttonText: "Quero o Anual",
        whatsappMessage: "Olá, tenho interesse no plano Mutante Anual."
      },
      {
        name: 'Semestral',
        price: '99,99',
        ...
        whatsappMessage: "Olá, tenho interesse no plano Mutante Semestral."
      },
      {
        name: 'Trimestral à Vista',
        price: '239,99',
        period: 'à vista',
        features: ['Musculação + Aulas completas', 'Pagamento único', 'Sem fidelidade trimestral', 'Válido por 90 dias'],
        highlighted: false,
        badgeText: null,
        discountText: null,
        buttonText: "Quero o Trimestral à Vista",
        whatsappMessage: "Olá, tenho interesse no plano Mutante Trimestral à Vista."
      },
      {
        name: 'Trimestral Parcelado',
        price: '109,99',
        period: '/mês',
        features: ['Musculação + Aulas completas', '3x no cartão', 'Economia no curto prazo', 'Fidelidade 3 meses'],
        highlighted: false,
        badgeText: null,
        discountText: null,
        buttonText: "Quero o Trimestral Parcelado",
        whatsappMessage: "Olá, tenho interesse no plano Mutante Trimestral Parcelado."
      },
      {
        name: 'Mensal',
        price: '149,99',
        ...
        whatsappMessage: "Olá, tenho interesse no plano Mutante Mensal."
      },
    ]
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Nos planos Mutante Anual e Mutante Semestral, você pode levar um convidado até 2 vezes por mês para treinar com você.',
      },
      {
  ...
  footer: {
    ...
    socialLinks: {
      instagram: "https://www.instagram.com/mutantegym",
      facebook: "https://www.facebook.com/p/mutantegym",
      youtube: "https://youtube.com/mutantegym"
    },
    quickLinks: [
      { label: 'Início', href: '#hero' },
